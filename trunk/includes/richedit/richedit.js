/*
 +-------------------------------------------------------------------+
 |                 J S - R I C H E D I T   (v1.12)                   |
 |                                                                   |
 | Copyright Gerd Tentler                www.gerd-tentler.de/tools   |
 | Created: Jun. 2, 2003                 Last modified: May 25, 2006 |
 +-------------------------------------------------------------------+
...
//---------------------------------------------------------------------------------------------------------
  ...
  this.initEditor = function(content) {
    if(this.editor = this.getEditor()) {
      ...
      for(var i = document.forms.length - 1; i > 0 && !this.field; i--) {
        ...
        //}
		this.field = document.forms[i].elements[this.fieldName];
      }
  ...
  this.toggleSource = function() {
	...
	var s = rtoGetObj(this.fieldName);
  ...
  this.buildEditor = function() {
	...
	document.writeln('<textarea name="' + this.fieldName + '" id="' + this.fieldName + '" class="cssSource' + this.id + '" wrap=virtual></textarea>');
    ...
    if(rto[this.id] = this) {
      if((IE || GK) && DM) {
        ...
        /*document.write('<textarea name="' + this.fieldName + this.id + '" style="' +
                       ...
                       '</textarea>');*/
		document.write('<textarea name="' + this.fieldName + '" style="' +
                       'margin-bottom: 4px; ' +
                       'padding: 4px; ' +
                       'background-color: ' + this.textBGColor + '; ' +
                       'border: ' + this.textBorder +
    ...
    for(i = 0; i < val.length; i++) {
      ...
      for(j = 0; j < val[i].length; j++) {
        ...
        if(percent < 0) {
          ...
          if(showVal < 2) graph += '<div style="float:left">' + Math.round(percent) + '%&nbsp;</div>';
...
function rtoGetWinXY() {
  ...
  if(document.body) {
    if(document.body.scrollLeft >= 0) scrLeft = document.body.scrollLeft;
    if(document.body.scrollTop >= 0) scrTop = document.body.scrollTop;
  }
  else {
    if(window.pageXOffset >= 0) scrLeft = window.pageXOffset;
...
if((IE || GK) && DM) {
  ...
  document.writeln('<div id="dlgTable" class="cssDialog"><center>' +
                   ...
                   '<input type=hidden name="id" value="">' +
                   '<table border=0 cellspacing=0>');
  document.writeln('<tr><td class="cssFont2" nowrap>' + txtColumns + ':</td><td>&nbsp;<input type=text name="Cols" size=2 maxlength=2 class="cssFormField"></td><td>&nbsp;</td><td class="cssFont2" nowrap>' + txtCellSpacing + ':</td><td>&nbsp;<input type=text name="Spacing" size=2 maxlength=2 class="cssFormField" value="2"></td></tr>');
  document.writeln('<tr><td class="cssFont2" nowrap>' + txtRows + ':</td><td>&nbsp;<input type=text name="Rows" size=2 maxlength=2 class="cssFormField"></td><td>&nbsp;</td><td class="cssFont2" nowrap>' + txtCellPadding + ':</td><td>&nbsp;<input type=text name="Padding" size=2 maxlength=2 class="cssFormField" value="2"></td></tr>');
  document.writeln('<tr><td class="cssFont2" nowrap>' + txtBorder + ':</td><td>&nbsp;<select name="Border" class="cssFormField"><option value="0">0<option value="1" selected>1<option value="2">2<option value="3">3<option value="4">4<option value="5">5</select></td><td>&nbsp;</td><td class="cssFont2" nowrap>' + txtBorderColor + ':</td><td>&nbsp;<input type=text name="BorderColor" size=10 maxlength=10 class="cssFormField" value="#000000"></td></tr>');
  document.writeln('<tr><td colspan=3></td><td class="cssFont2" nowrap>' + txtCellColor + ':</td><td>&nbsp;<input type=text name="CellColor" size=10 maxlength=10 class="cssFormField"></td></tr>');
  document.writeln('</table>' +
                   '<table border=0 cellspacing=0 cellpadding=0 width=230><tr>' +
  ...
  document.writeln('<div id="dlgGraph" class="cssDialog"><center>' +
                   ...
                   '<input type=hidden name="id" value="">' +
                   '<table border=0 cellspacing=0>');
  document.writeln('<tr><td class="cssFont2" nowrap>' + txtValues + ':</td><td>&nbsp;<input name="Values" type=text size=10 class="cssFormField" title="123[;...], 123[;...], ..."></td><td>&nbsp;</td><td class="cssFont2" nowrap>' + txtBarColor + ':</td><td>&nbsp;<input type=text name="BarColor" size=10 class="cssFormField"></td></tr>');
  document.writeln('<tr><td class="cssFont2" nowrap>' + txtLabels + ':</td><td>&nbsp;<input type=text name="Labels" size=10 class="cssFormField" title="abc, abc, ..."></td><td>&nbsp;</td><td class="cssFont2" nowrap>' + txtLabelColor + ':</td><td>&nbsp;<input type=text name="LabelColor" size=10 class="cssFormField"></td></tr>');
  document.writeln('<tr><td class="cssFont2" nowrap>' + txtLegend + ':</td><td>&nbsp;<input type=text name="Legend" size=10 class="cssFormField" title="abc, abc, ..."></td><td>&nbsp;</td><td class="cssFont2" nowrap>' + txtViewValues + ':</td><td>&nbsp;<select name="ViewValues" class="cssFormField"><option value="">%<option value="1">abs. + %<option value="2">abs.<option value="3">-</select></td></tr>');
  document.writeln('</table>' +
                   '<table border=0 cellspacing=0 cellpadding=0 width=230><tr>' +
